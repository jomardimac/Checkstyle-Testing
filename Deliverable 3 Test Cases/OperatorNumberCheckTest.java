...
import net.sf.eclipsecs.sample.checks.OperatorNumberCheck;

/**
 * The class <code>OperatorNumberCheckTest</code> contains tests for the class <code>{@link OperatorNumberCheck}</code>.
 *
 * @generatedBy CodePro at 12/10/17 8:12 PM
 * @author Devon Honig
 * @version $Revision: 1.0 $
 */
public class OperatorNumberCheckTest {
	/**
	 * Run the OperatorNumberCheck() constructor test.
	 *
	 * @generatedBy CodePro at 12/10/17 8:12 PM
	 */
	@Test
	public void testOperatorNumberCheck_1()
		throws Exception {
		OperatorNumberCheck result = new OperatorNumberCheck();
	...
	public void testGetDefaultTokens_1()
		throws Exception {
		OperatorNumberCheck fixture = new OperatorNumberCheck();
		fixture.setMax(1);
	...
	public void testGetDetailASTsForTypeInBranch_1()
		...
		int result = OperatorNumberCheck.getDetailASTsForTypeInBranch(expr, tokenType, list, unique);
	...
	public void testVisitToken_1()
		...
		//       at net.sf.eclipsecs.sample.checks.OperatorNumberCheck.getDetailASTsForTypeInBranch(OperatorNumberCheck.java:57)
		//       at net.sf.eclipsecs.sample.checks.OperatorNumberCheck.visitToken(OperatorNumberCheck.java:38)
	}
	...
	public static void main(String[] args) {
		new org.junit.runner.JUnitCore().run(OperatorNumberCheckTest.class);
	}
}